...
void Datafile::Save(string filename, string comments, bool skip_unused)
{
    ...
    for (unsigned int r = 0; r < n_reps; ++r)
    {
        ...
        for (unsigned int row = 0; row < (skip_unused ? used_rows[r] : n_rows[r]); ++row)
        {
